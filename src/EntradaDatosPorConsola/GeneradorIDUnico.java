...
public class GeneradorIDUnico {
    public static void main(String[] args){
        ...
        String nombreFormateado = nombre.substring(0, 2).toUpperCase().trim(); // Primeras dos letras del nombre en mayúsculas
        String apellidoFormateado = apellido.substring(0, 2).toUpperCase().trim(); // Primeras dos letras del apellido en mayúsculas
        String nacimientoFormateado = nacimiento.substring(2, 4).trim(); // Últimos dos dígitos del año de nacimiento         
